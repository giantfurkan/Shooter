...
void AWeapon::UpdateSlideDisplacment()
{
	if (SlideDisplacementCurve && bMovingSlide)
	{
		...
		SlideDisplacement = CurveValue * MaxSlideDisplacment;
		RecoilRotation = CurveValue * MaxRecoilRotation;
		UE_LOG(LogTemp, Warning, TEXT("update working well"));
...
void AWeapon::StartSlideTimer()
{
	...
	UE_LOG(LogTemp, Warning, TEXT("start slide timer working well"));
}
